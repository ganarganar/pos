odoo.define("l10n_ar_pos_einvoice_ticket.models", function(require) {
    ...
    screens.ReceiptScreenWidget.include({
                            ...
                            rpc.query({
                                ...
                                rpc.query({
                                     ...
                                     args: [[["id", "=", partner_id]], ["vat",
                                                                        ...
                                                                        "street", "city", "state_id", "company_registry"]],
                                    }
                                    ...
                                    rpc.query({
                                        ...
                                        var receipt = qweb.render("OrderReceipt", self.receipt_data);
        ...
        render_receipt: function() {
            ...
            if (!this.pos.config.iface_print_via_proxy && this.pos.config.show_invoice_number && order.is_to_invoice()) {
